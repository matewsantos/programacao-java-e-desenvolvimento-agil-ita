...
public class UsuarioDaoTest {
    ...
    public void database() throws Exception {
        ...
        IDataSet dataSet = loader.load("/dominio/database-images/usuarios-inicio.xml");
    ...
    public void testeInsercao() throws Exception {
        ...
        ITable tabelaEsperada = loader.load("/dominio/database-images/usuarios-apos-insercao.xml").getTable("usuario");
    ...
    public void testeAdicionaPontos() throws Exception {
        ...
        ITable tabelaCorrente = jdt.getConnection().createDataSet().getTable("usuario");
        ITable tabelaEsperada= loader.load("/dominio/database-images/usuarios-apos-adicao-de-pontos.xml").getTable("usuario");
